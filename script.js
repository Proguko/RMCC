...
class ingame{
    constructor(name = "The Chosen One (clichê)"){
        ...
        this.inflaoutput = document.getElementById("inflation-bar")
        ...
        this.democratization = document.getElementById("democrat-bar");
    ...
    getchoc(){ //Adquirir chocolates
        ...
        this.inflaoutput.value = (this.chocolates*this.price)/10
        this.price = (this.chocolates+1)/10
    ...
    speech(){ //Discursar publicamente
        if(this.knowoutput.value >= 30 && this.reputation.value >= 40){
            ...
            this.democratization.value = this.spchform*(this.knowoutput.value+this.democratization.value-1)/100
